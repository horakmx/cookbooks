...
php_fpm_pool "#{node['webpagetest']['system_user']}" do
    user "#{node['webpagetest']['system_user']}"
    group "#{node['webpagetest']['system_group']}"
    listen "/var/run/fpm-#{node['webpagetest']['system_user']}.socket"
    listen_owner "#{node['webpagetest']['system_user']}"
	listen_group "#{node['webpagetest']['system_group']}"
	listen_mode  "0666"
	...
	php_options 'php_admin_flag[log_errors]' 						=> 'on',
				...
				'php_admin_value[open_basedir]' 					=> "#{node['webpagetest']['root_directory']}:/usr/share/php:/usr/share/locale:/mnt/share:/home/common:/tmp",
				'php_admin_value[upload_tmp_dir]' 					=> "#{node['webpagetest']['root_directory']}/tmp",
				'php_admin_value[display_errors]' 					=> "1",
				'php_admin_value[upload_max_filesize]' 				=> "10M",
				'php_admin_value[post_max_size]' 					=> "10M",
				'php_admin_value[xdebug.profiler_output_dir]' 		=> "#{node['webpagetest']['root_directory']}/xdebug",
